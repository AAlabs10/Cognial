...
const Part = () => {
  const features = [
    ...
    {
      icon: <FiClock className="text-indigo-500 text-2xl" />,
    ...
    {
      icon: <FiBarChart2 className="text-indigo-500 text-2xl" />,
    ...
    {
      icon: <FiAward className="text-indigo-500 text-2xl" />,
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16">
          <div className="max-w-2xl mb-8 md:mb-0">
            <p className="text-indigo-500 font-bold tracking-wide uppercase text-sm">
              How It Works
            </p>
            <h2 className="mt-2 text-3xl lg:text-4xl font-extrabold text-gray-900 tracking-tight">
              Unlock the <span className="text-indigo-500">Power of Your Data</span> with Thinkora
            </h2>
